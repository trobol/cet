...
set(CMAKE_LIB "${CMAKE_CURRENT_LIST_DIR}/zig-lib${SCRIPT_SUFFIX}" -target ${ZIG_TARGET})
...
set(CMAKE_C_COMPILER_ID "${CMAKE_CURRENT_LIST_DIR}/zig-cc${SCRIPT_SUFFIX}")
set(CMAKE_CXX_COMPILER_ID "${CMAKE_CURRENT_LIST_DIR}/zig-c++${SCRIPT_SUFFIX}") 